...
static void send_frame(){
    ...
    wret = send(data_socket, bd_list[current_tx_bd].tx.ptr, bd_list[current_tx_bd].tx.len, MSG_NOSIGNAL);
    return;
}
...
uint32_t IOB_ETH_GET_INT_SOURCE() {
    return 0;
}
...
uint32_t IOB_ETH_GET_PACKETLEN() {
    return 0;
}
...
uint32_t IOB_ETH_GET_COLLCONF() {
    return 0;
}

void IOB_ETH_SET_TX_BD_NUM(uint32_t value) {
    tx_bd_num = (uint8_t)value;
}

uint32_t IOB_ETH_GET_TX_BD_NUM() {
    return tx_bd_num;
}
...
uint32_t IOB_ETH_GET_CTRLMODER() {
    return 0;
}
...
uint32_t IOB_ETH_GET_MIICOMMAND() {
    return 0;
}
...
uint32_t IOB_ETH_GET_MIIADDRESS() {
    return 0;
}
...
uint32_t IOB_ETH_GET_MIITX_DATA() {
    return 0;
}
...
uint32_t IOB_ETH_GET_MIIRX_DATA() {
    return 0;
}
...
uint32_t IOB_ETH_GET_MIISTATUS() {
    return 0;
}
...
uint32_t IOB_ETH_GET_MAC_ADDR0() {
    return 0;
}
...
uint32_t IOB_ETH_GET_MAC_ADDR1() {
    return 0;
}
...
uint32_t IOB_ETH_GET_ETH_HASH0_ADR() {
    return 0;
}
...
uint32_t IOB_ETH_GET_ETH_HASH1_ADR() {
    return 0;
}
...
uint32_t IOB_ETH_GET_ETH_TXCTRL() {
    return 0;
}

// No DMA interface
uint8_t IOB_ETH_GET_TX_BD_CNT() {
    return 0;
}

uint8_t IOB_ETH_GET_RX_BD_CNT() {
    return 0;
}

uint32_t IOB_ETH_GET_TX_WORD_CNT() {
    return 0;
}

uint32_t IOB_ETH_GET_RX_WORD_CNT() {
    return 0;
}
...
uint32_t IOB_ETH_GET_FRAME_WORD() {
    return 0;
}
...
uint32_t IOB_ETH_GET_BD(int addr) {
