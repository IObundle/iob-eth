 ...
 *
 * Patched by IObundle for improved PHY chip management:
 * - Added phy_interface field to struct ethoc for configurable PHY modes
 * - Replaced hardcoded PHY_INTERFACE_MODE_GMII with priv->phy_interface
 * - Added of_get_phy_mode() to read phy-mode from device tree
 */
