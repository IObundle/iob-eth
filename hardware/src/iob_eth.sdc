...
set_output_delay -clock {clk} $clk_o_delay [get_ports {iob_csrs_iob_rvalid_o}]
set_output_delay -clock {clk} $clk_o_delay [get_ports {iob_csrs_iob_rdata_o[*]}]
set_output_delay -clock {clk} $clk_o_delay [get_ports {iob_csrs_iob_ready_o}]
