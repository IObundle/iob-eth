...
# MII interface
set_output_delay -clock {tx_clk} $eth_i_delay [get_ports {mii_txd_o[*]}]
set_output_delay -clock {tx_clk} $eth_i_delay [get_ports {mii_tx_en_o}]
set_output_delay -clock {tx_clk} $eth_i_delay [get_ports {mii_tx_er_o}]
...
# CSRS Interface
set_input_delay -clock {clk} $clk_i_delay [get_ports {iob_csrs_iob_valid_i}]
set_input_delay -clock {clk} $clk_i_delay [get_ports {iob_csrs_iob_addr_i[*]}]
set_input_delay -clock {clk} $clk_i_delay [get_ports {iob_csrs_iob_wdata_i[*]}]
set_input_delay -clock {clk} $clk_i_delay [get_ports {iob_csrs_iob_wstrb_i[*]}]
set_output_delay -clock {clk} $clk_i_delay [get_ports {iob_csrs_iob_rvalid_o}]
set_output_delay -clock {clk} $clk_i_delay [get_ports {iob_csrs_iob_rdata_o[*]}]
set_output_delay -clock {clk} $clk_i_delay [get_ports {iob_csrs_iob_ready_o}]
