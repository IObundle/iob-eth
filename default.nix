...
let
  py2hwsw_commit = "55c9cd567b8f5cf65705a32e74010c888ab71d4a"; # Replace with the desired commit.
  py2hwsw_sha256 = "kMTAAirnsHu9KdrBS7hF+DRxg9m6uMMkDe8D4Gt5ekM="; # Replace with the actual SHA256 hash.
