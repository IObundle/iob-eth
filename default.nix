...
let
  py2hwsw_commit = "f58fb75b31b2cea730547ced6c8d14802aaef4e5"; # Replace with the desired commit.
  py2hwsw_sha256 = "hq2qna47FGD/DKTQg7JeTyD+pdTif323hLTsqbFZ5hc="; # Replace with the actual SHA256 hash.
