...
let
  py2hwsw_commit = "c5cc6cd81f84917a4e7ecaf34695291942047709"; # Replace with the desired commit.
  py2hwsw_sha256 = "IMScxSehwcxYibEuP4w0rNBpQY9CBbPO+WY3Fbf2fQU="; # Replace with the actual SHA256 hash.
