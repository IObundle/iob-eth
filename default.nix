...
let
  py2hwsw_commit = "266854a9454d4489f6e59fa86e9c93e4e8e037d3"; # Replace with the desired commit.
  py2hwsw_sha256 = "bxvIEd4wQghcfs6r+hF+vrdm+lqYlrpUFrtALUFfzCw="; # Replace with the actual SHA256 hash.
