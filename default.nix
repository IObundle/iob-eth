...
let
  py2hwsw_commit = "c53fc3ec79dbbdcb40a618c13a221dc6f65d8b98"; # Replace with the desired commit.
  py2hwsw_sha256 = "kB0yyw/eLTuOfhCPLkbqHKTHpV+G43MLR7CdKjvNs2M="; # Replace with the actual SHA256 hash.
