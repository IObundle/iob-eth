...
let
  py2hwsw_commit = "e8a55b6987ece13164214a4feaa465ed20ce8d4d"; # Replace with the desired commit.
  py2hwsw_sha256 = "fXgYk8wRwVwvNEub6mKIS9ze4v1h+yUjIcHiFaAk1jo="; # Replace with the actual SHA256 hash.
