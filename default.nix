...
let
  py2hwsw_commit = "da2449e2e2d4322b36c89ae36294bd92a29bf911"; # Replace with the desired commit.
  py2hwsw_sha256 = "JobEovoYK+X1FdXBOHb5Yzq4YjC7CDLUiV2/jkE5T5k="; # Replace with the actual SHA256 hash.
